...
# hits VK_ERROR_DEVICE_LOST + SIGABRT within seconds). Force the
# OpenGL/ngl renderer so GTK 4 stays on Mesa's GL stack (which is
# either llvmpipe or d3d12 per GALLIUM_DRIVER above).
GSK_RENDERER=ngl
EOF
    else
